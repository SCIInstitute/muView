...
/*
const int DRL_Wrapper::METHOD_PCA    = 0;
const int DRL_Wrapper::METHOD_MDS    = 1;
const int DRL_Wrapper::METHOD_LLE    = 2;
const int DRL_Wrapper::METHOD_ISOMAP = 3;
const int DRL_Wrapper::METHOD_AE     = 4;
*/
