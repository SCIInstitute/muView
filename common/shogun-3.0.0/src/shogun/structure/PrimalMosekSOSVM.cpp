...
{
	SG_ADD4(&m_slacks, "slacks", "Slacks vector", MS_NOT_AVAILABLE);
	//FIXME model selection available for SO machines
	SG_ADD4(&m_regularization, "regularization", "Regularization constant", MS_NOT_AVAILABLE);
	SG_ADD4(&m_epsilon, "epsilon", "Violation tolerance", MS_NOT_AVAILABLE);
