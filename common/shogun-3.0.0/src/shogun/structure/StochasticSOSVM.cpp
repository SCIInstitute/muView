...
{
	SG_ADD4(&m_lambda, "lambda", "Regularization constant", MS_NOT_AVAILABLE);
	SG_ADD4(&m_num_iter, "num_iter", "Number of iterations", MS_NOT_AVAILABLE);
	SG_ADD4(&m_do_weighted_averaging, "do_weighted_averaging", "Do weighted averaging", MS_NOT_AVAILABLE);
	SG_ADD4(&m_debug_multiplier, "debug_multiplier", "Debug multiplier", MS_NOT_AVAILABLE);
	SG_ADD4(&m_rand_seed, "rand_seed", "Random seed", MS_NOT_AVAILABLE);
