...
{
	SG_UNSTABLE("CMAPInference::CMAPInference()", "shogun\n");
...
{
	SG_ADD4((CSGObject**)&m_fg, "fg", "factor graph", MS_NOT_AVAILABLE);
	SG_ADD4((CSGObject**)&m_outputs, "outputs", "Structured outputs", MS_NOT_AVAILABLE);
	SG_ADD4((CSGObject**)&m_infer_impl, "infer_impl", "Inference implementation", MS_NOT_AVAILABLE);
	SG_ADD4(&m_energy, "energy", "Minimized energy", MS_NOT_AVAILABLE);
