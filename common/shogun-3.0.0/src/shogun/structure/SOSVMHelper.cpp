...
{
	SG_ADD4(&m_primal, "primal", "History of primal values", MS_NOT_AVAILABLE);
	SG_ADD4(&m_dual, "dual", "History of dual values", MS_NOT_AVAILABLE);
	SG_ADD4(&m_duality_gap, "duality_gap", "History of duality gaps", MS_NOT_AVAILABLE);
	SG_ADD4(&m_eff_pass, "eff_pass", "Effective passes", MS_NOT_AVAILABLE);
	SG_ADD4(&m_train_error, "train_error", "History of training errors", MS_NOT_AVAILABLE);
	SG_ADD4(&m_tracker, "tracker", "Tracker of training progress", MS_NOT_AVAILABLE);
	SG_ADD4(&m_bufsize, "bufsize", "Buffer size", MS_NOT_AVAILABLE);
