...
{
	SG_ADD4((CSGObject**)&m_factor_types, "factor_types", "Array of factor types", MS_NOT_AVAILABLE);
	SG_ADD4(&m_w_cache, "w_cache", "Cache of global parameters", MS_NOT_AVAILABLE);
	SG_ADD4(&m_w_map, "w_map", "Parameter mapping", MS_NOT_AVAILABLE);
