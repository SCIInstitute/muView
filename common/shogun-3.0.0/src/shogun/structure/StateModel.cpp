...
{
	SG_ADD4(&m_num_states, "m_num_states", "The number of states", MS_NOT_AVAILABLE);
	SG_ADD4(&m_num_transmission_params, "m_num_tranmission_params",
			"The number of tranmission parameters", MS_NOT_AVAILABLE);
	SG_ADD4(&m_state_loss_mat, "m_state_loss_mat", "The state loss matrix",
			MS_NOT_AVAILABLE);
	SG_ADD4(&m_p, "m_p", "The distribution of start states", MS_NOT_AVAILABLE);
	SG_ADD4(&m_q, "m_q", "The distribution of stop states", MS_NOT_AVAILABLE);
