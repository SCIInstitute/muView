...
{
	SG_ADD4(&m_degree, "m_degree", "the order of the kernel", MS_AVAILABLE);
	SG_ADD4(&m_win_len, "m_win_len", "the window length", MS_AVAILABLE);
	SG_ADD4(&m_inhomogene, "m_inhomogene",
