...
void CSpectrumRBFKernel::register_param()
{
	...
	SG_ADD4(&AA_matrix, "AA_matrix", "128*128 scalar product matrix", MS_NOT_AVAILABLE);
	SG_ADD4(&width, "width", "width of Gaussian", MS_AVAILABLE);
	SG_ADD4(&nof_sequences, "nof_sequences", "length of the sequence",
	    MS_NOT_AVAILABLE);
	m_parameters->add_vector(&sequences, &nof_sequences, "sequences", "the sequences as a part of profile");
	SG_ADD4(&max_sequence_length,
