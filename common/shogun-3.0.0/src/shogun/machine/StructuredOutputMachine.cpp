...
{
	SG_ADD4((CSGObject**)&m_model, "m_model", "Structured model", MS_NOT_AVAILABLE);
	SG_ADD4((CSGObject**)&m_surrogate_loss, "m_surrogate_loss", "Surrogate loss", MS_NOT_AVAILABLE);
	SG_ADD4(&m_verbose, "verbose", "Verbosity flag", MS_NOT_AVAILABLE);
	SG_ADD4((CSGObject**)&m_helper, "helper", "Training helper", MS_NOT_AVAILABLE);
