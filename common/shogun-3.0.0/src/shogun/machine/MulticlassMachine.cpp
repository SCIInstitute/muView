...
{
	SG_ADD4((CSGObject**)&m_multiclass_strategy,"m_multiclass_type", "Multiclass strategy", MS_NOT_AVAILABLE);
	SG_ADD4((CSGObject**)&m_machine, "m_machine", "The base machine", MS_NOT_AVAILABLE);
}
