...
public:
	...
	{
		SG_ADD4((CSGObject**)&m_left,"m_left", "Left subtree", MS_NOT_AVAILABLE);
		SG_ADD4((CSGObject**)&m_right,"m_right", "Right subtree", MS_NOT_AVAILABLE);
		SG_ADD4((CSGObject**)&m_parent,"m_parent", "Parent node", MS_NOT_AVAILABLE);
		SG_ADD4(&m_machine,"m_machine", "Index of associated machine", MS_NOT_AVAILABLE);
	}
