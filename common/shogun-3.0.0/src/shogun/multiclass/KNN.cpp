...
void CKNN::init()
{
	...
	SG_ADD4(&m_q, "m_q", "Parameter q", MS_AVAILABLE);
	SG_ADD4(&m_use_covertree, "m_use_covertree", "Parameter use_covertree", MS_NOT_AVAILABLE);
	SG_ADD4(&m_num_classes, "m_num_classes", "Number of classes", MS_NOT_AVAILABLE);
}
