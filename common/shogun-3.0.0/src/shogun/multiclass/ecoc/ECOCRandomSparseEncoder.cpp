...
{
    SG_ADD4(&m_maxiter, "maxiter", "max number of iterations", MS_NOT_AVAILABLE);
    SG_ADD4(&m_codelen, "codelen", "code length", MS_NOT_AVAILABLE);
    SG_ADD4(&m_pzero, "pzero", "probability of 0", MS_NOT_AVAILABLE);
    SG_ADD4(&m_pposone, "pposone", "probability of +1", MS_NOT_AVAILABLE);
    SG_ADD4(&m_pnegone, "pnegone", "probability of -1", MS_NOT_AVAILABLE);
}
