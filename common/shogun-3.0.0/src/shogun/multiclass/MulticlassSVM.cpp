...
{
	SG_ADD4(&m_C, "C", "C regularization constant",MS_AVAILABLE);
	m_C=0;
}
...
bool CMulticlassSVM::save(FILE* modelfl)
{
	...
	for (int32_t i=0; i<m_machines->get_num_elements(); i++)
	{
		...
		{
			fprintf(modelfl,"shogun\t[%+10.16e,%d];\n",
