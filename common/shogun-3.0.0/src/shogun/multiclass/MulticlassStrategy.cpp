...
void CMulticlassStrategy::init()
{
	...
	SG_ADD4((CSGObject**)&m_rejection_strategy, "rejection_strategy", "Strategy of rejection", MS_NOT_AVAILABLE);
	SG_ADD4(&m_num_classes, "num_classes", "Number of classes", MS_NOT_AVAILABLE);
	//SG_ADD4((machine_int_t*)&m_prob_heuris, "prob_heuris", "Probability estimation heuristics", MS_NOT_AVAILABLE);
