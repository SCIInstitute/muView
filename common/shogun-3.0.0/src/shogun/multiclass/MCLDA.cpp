...
void CMCLDA::init()
{
	SG_ADD4(&m_tolerance, "m_tolerance", "Tolerance member.", MS_AVAILABLE);
	SG_ADD4(&m_store_cov, "m_store_cov", "Store covariance member", MS_NOT_AVAILABLE);
	SG_ADD4((CSGObject**) &m_features, "m_features", "Feature object.", MS_NOT_AVAILABLE);
	SG_ADD4(&m_means, "m_means", "Mean vectors list", MS_NOT_AVAILABLE);
	SG_ADD4(&m_cov, "m_cov", "covariance matrix", MS_NOT_AVAILABLE);
	SG_ADD4(&m_xbar, "m_xbar", "total mean", MS_NOT_AVAILABLE);
	SG_ADD4(&m_scalings, "m_scalings", "scalings", MS_NOT_AVAILABLE);
	SG_ADD4(&m_rank, "m_rank", "rank", MS_NOT_AVAILABLE);
	SG_ADD4(&m_coef, "m_coef", "weight vector", MS_NOT_AVAILABLE);
	SG_ADD4(&m_intercept, "m_intercept", "intercept", MS_NOT_AVAILABLE);
