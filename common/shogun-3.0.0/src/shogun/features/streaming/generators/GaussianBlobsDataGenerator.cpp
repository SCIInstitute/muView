...
{
	SG_ADD4(&m_sqrt_num_blobs, "sqrt_num_blobs", "Number of Blobs per row",
				MS_NOT_AVAILABLE);
	SG_ADD4(&m_distance, "distance", "Distance between blobs",
				MS_NOT_AVAILABLE);
	SG_ADD4(&m_stretch, "stretch", "Stretch of blobs",
				MS_NOT_AVAILABLE);
	SG_ADD4(&m_angle, "angle", "Angle of Blobs",
				MS_NOT_AVAILABLE);
	SG_ADD4(&m_cholesky, "cholesky", "Cholesky factor of covariance matrix",
				MS_NOT_AVAILABLE);
