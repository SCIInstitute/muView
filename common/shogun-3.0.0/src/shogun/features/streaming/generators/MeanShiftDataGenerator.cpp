...
{
	SG_ADD4(&m_dimension, "dimension", "Dimension of data", MS_NOT_AVAILABLE);
	SG_ADD4(&m_mean_shift, "mean_shift", "Mean shift in one dimension",
			MS_NOT_AVAILABLE);
	SG_ADD4(&m_dimension_shift, "m_dimension_shift", "Dimension of mean shift",
			MS_NOT_AVAILABLE);
