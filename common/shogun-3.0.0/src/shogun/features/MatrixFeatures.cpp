...
{
	SG_ADD4(&m_num_vectors, "m_num_vectors", "Number of feature vectors",
			MS_NOT_AVAILABLE);
	SG_ADD4(&m_num_features, "m_num_features",
			"Number of features per vector (optional)", MS_NOT_AVAILABLE);
	//TODO add SG_ADD for SGMatrixList
	//SG_ADD4(&m_features, "m_features", "Matrix features", MS_NOT_AVAILABLE);
