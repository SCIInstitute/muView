...
void CLBPPyrDotFeatures::init(CDenseFeatures<uint32_t>* image_set, int32_t image_w, int32_t image_h)
{
	...
	SG_ADD4((CSGObject**) &images, "images", "Set of images", MS_NOT_AVAILABLE);
	SG_ADD4(&image_width, "image_width", "The image width", MS_NOT_AVAILABLE);
	SG_ADD4(&image_height, "image_height", "The image height", MS_NOT_AVAILABLE);
	SG_ADD4(&vec_nDim, "vec_nDim", "The dimension of the pyr", MS_NOT_AVAILABLE);
}
