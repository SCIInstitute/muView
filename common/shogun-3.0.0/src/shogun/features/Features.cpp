...
void CFeatures::init()
{
	SG_ADD4(&properties, "properties", "Feature properties", MS_NOT_AVAILABLE);
	SG_ADD4(&cache_size, "cache_size", "Size of cache in MB", MS_NOT_AVAILABLE);

	SG_ADD4((CSGObject**) &preproc, "preproc", "Array of preprocessors.",
	       MS_NOT_AVAILABLE);
	SG_ADD4((CSGObject**) &preprocessed, "preprocessed", "Array of preprocessed.",
	       MS_NOT_AVAILABLE);

	SG_ADD4((CSGObject**)&m_subset_stack, "subset_stack", "Stack of subsets",
	       MS_NOT_AVAILABLE);
