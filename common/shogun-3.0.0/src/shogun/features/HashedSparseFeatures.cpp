	...
	bool keep_lin_terms)
{
	...
	SG_ADD4(&use_quadratic, "use_quadratic", "Whether to use quadratic features",
		MS_NOT_AVAILABLE);
	SG_ADD4(&keep_linear_terms, "keep_linear_terms", "Whether to keep the linear terms or not",
		MS_NOT_AVAILABLE);
	SG_ADD4(&dim, "dim", "Dimension of new feature space", MS_NOT_AVAILABLE);
	SG_ADD4((CSGObject** ) &sparse_feats, "sparse_feats", "Sparse features to work on",
		MS_NOT_AVAILABLE);
