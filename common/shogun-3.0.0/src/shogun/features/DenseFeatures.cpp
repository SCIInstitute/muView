...
template<class ST> void CDenseFeatures<ST>::init()
{
	...
	SG_ADD4(&num_vectors, "num_vectors", "Number of vectors.", MS_NOT_AVAILABLE);
	SG_ADD4(&num_features, "num_features", "Number of features.", MS_NOT_AVAILABLE);
	SG_ADD4(&feature_matrix, "feature_matrix",
