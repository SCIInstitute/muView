...
{
	SG_ADD4((CSGObject**)&m_feature_relation, "feature_relation", "feature relation", MS_NOT_AVAILABLE);
	SG_ADD4(&m_z, "z", "regularization coefficient", MS_AVAILABLE);
	SG_ADD4(&m_q, "q", "q of L1/Lq", MS_AVAILABLE);
	SG_ADD4(&m_termination, "termination", "termination", MS_NOT_AVAILABLE);
	SG_ADD4(&m_regularization, "regularization", "regularization", MS_NOT_AVAILABLE);
	SG_ADD4(&m_tolerance, "tolerance", "tolerance", MS_NOT_AVAILABLE);
	SG_ADD4(&m_max_iter, "max_iter", "maximum number of iterations", MS_NOT_AVAILABLE);
}
