...
void CTask::init()
{
	...
	SG_ADD4((CSGObject**)&m_subtasks,"subtasks","subtasks of given task", MS_NOT_AVAILABLE);
	SG_ADD4(&m_indices,"indices","indices of task", MS_NOT_AVAILABLE);
	SG_ADD4(&m_weight,"weight","weight of task", MS_NOT_AVAILABLE);
}
