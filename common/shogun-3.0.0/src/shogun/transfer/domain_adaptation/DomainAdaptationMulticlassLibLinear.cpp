...
{
	SG_ADD4((CSGObject**)&m_source_machine, "source_machine", "source domain machine",
			MS_NOT_AVAILABLE);
	SG_ADD4(&m_train_factor, "train_factor", "factor of target domain regularization",
			MS_AVAILABLE);
	SG_ADD4(&m_source_bias, "source_bias", "bias to source domain",
			MS_AVAILABLE);
}
