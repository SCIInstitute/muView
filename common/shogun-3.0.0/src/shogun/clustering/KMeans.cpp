...
void CKMeans::init()
{
	...
	SG_ADD4(&max_iter, "max_iter", "Maximum number of iterations", MS_AVAILABLE);
	SG_ADD4(&k, "k", "k, the number of clusters", MS_AVAILABLE);
	SG_ADD4(&dimensions, "dimensions", "Dimensions of data", MS_NOT_AVAILABLE);
	SG_ADD4(&R, "R", "Cluster radiuses", MS_NOT_AVAILABLE);
}
