...
CRandomFourierGaussPreproc::CRandomFourierGaussPreproc() :
	...
	if(m_parameters)
	{
		SG_ADD4(&dim_input_space, "dim_input_space",
		    "Dimensionality of the input space.", MS_NOT_AVAILABLE);
		SG_ADD4(&cur_dim_input_space, "cur_dim_input_space",
		    "Dimensionality of the input space.", MS_NOT_AVAILABLE);
		SG_ADD4(&dim_feature_space, "dim_feature_space",
		    "Dimensionality of the feature space.", MS_NOT_AVAILABLE);
		SG_ADD4(&cur_dim_feature_space, "cur_dim_feature_space",
		    "Dimensionality of the feature space.", MS_NOT_AVAILABLE);

		SG_ADD4(&kernelwidth, "kernelwidth", "Kernel width.", MS_AVAILABLE);
		SG_ADD4(&cur_kernelwidth, "cur_kernelwidth", "Kernel width.", MS_AVAILABLE);
