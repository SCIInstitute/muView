...
{
	SG_ADD4(&m_min, "min", "minimum values of each feature", MS_NOT_AVAILABLE);
	SG_ADD4(&m_range, "range", "Reciprocal of the range of each feature", MS_NOT_AVAILABLE);
	SG_ADD4(&m_initialized, "initialized", "Indicator of the state of the preprocessor.", MS_NOT_AVAILABLE);
}
